                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-header-title">
                                <h1 class="pull-left page-title">Farmers</h1>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">List of Farmers</h3>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <table id="datatable" class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    <?php $i=1; foreach($getfarmers as $key=>$farmer): ?>
                                                        <tr>
                                                          <td><?php echo $i; ?></td>
                                                            ...
                                                            <td><?php echo $farmer['total_land']; ?></td>
                                                            <td><a href="update_farmer.php?id=<?= $farmer['id'];?>" class="btn btn-info btn-sm">Update</a>
                                                                <form  action="controller/FarmerController.php" method="post" style="display: inline-block;">
