 <?php
 session_start();
 if(empty($_SESSION['user_id']) && $_SESSION['doctor_type']==''){
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-header-title">
                                <h1 class="pull-left page-title">Doctors</h1>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <table id="datatable" class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    <?php $i=1; foreach($getdoctors as $key=>$doctor): ?>
                                                        <tr>
                                                            ...
                                                            <td><a href="update_doctor.php?id=<?= $doctor['id'];?>" class="btn btn-info btn-sm">Update</a>
                                                                <form  action="controller/doctorController.php" method="post" style="display: inline-block;">
